...
1. **Repository'yi klonla:**
   ```bash
   git clone https://github.com/umut-baris/Candy_Mike_2D_Platformer.git

2. **Unity'de aç:**

Unity Hub → Add Project → Klonlanan klasörü seç

Unity 2022.3 LTS veya üzeri gerekli

3. **Oyna:**

Scenes/MainScene.unity dosyasını aç
